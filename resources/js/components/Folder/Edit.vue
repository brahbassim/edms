    ...
    <div class="container-fluid">
        ...
        <div class="bg-white mt-4 mb-4">
            <div class="row clearfix">
                <div class="col-sm-12">
                    <button type="button" class="btn btn-primary btn-round btn-warning float-right" @click.prevent="save(folder_data)" :disabled="loading">
                        <template v-if="!loading"><i class='fa fa-save'></i> METTRE A JOUR</template>
        ...
        <div class="bg-white mt-4 mb-4 row">
            <div class="col-sm-12">
                ...
                <input type="button" class="btn btn-link" @click.stop="addLine" value="Ajouter une personne +">
            </div>
        </div>
    </div>
</template>
...
<script>
    ...
    export default {
        props:['categories_data','folder_data','members_data'],
        data () {
            return {
                errors: [],
                setting:{},
